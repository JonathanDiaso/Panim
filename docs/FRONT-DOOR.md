...
`.btn-begin`, and found his sister filed in the index under the wrong woman's note.
🗄 **v57–v60 moved to [`../archive/round-records-v57-to-v60.md`](../archive/round-records-v57-to-v60.md), 2026-09-07** — four
shipped rounds that used to sit between §3 and §8. **Every ruling in them still stands**;
§4 here is the index into them.
...
live) and §8 (the round that actually shipped last). **Do not re-derive any of the
below — go read it:**
