...
cue id. The **ribbon caption and the plate titles came off Literata's reading optical size onto
its display one** — they were text type enlarged, which was the whole of the flatness — and the
reserved-height ladder was re-swept at 1px resolution, where every step moved and the base
gained a line. And the **five-minute card now knows you have heard it.**
🗄 **v69–v73 moved to [`../archive/round-records-v69-to-v73.md`](../archive/round-records-v69-to-v73.md), 2026-09-09** —
five shipped rounds that had piled into the gap §13 cleared, **45% of this file.** §18 here is
the index into them: v69's two defects and the offline Greek, v70's deleted second edition,
**v71's read-along mark that was a no-op on 1,725 of 1,841 cue blocks**, v72's offline warning,
and v73 above. **Every ruling in them still stands, with one marked reversal — §17.1.**
🗄 **v61–v67 moved to [`../archive/round-records-v61-to-v67.md`](../archive/round-records-v61-to-v67.md), 2026-09-09** — five
shipped rounds. **§13 here is the index into them**, and it is where §8's mark alignment, §9's
dead-rule *method*, §11's reserved-height sweep and §12's italic caption now live.
...
⚠️ **THE SECTION NUMBERS SKIP §5–§12 AND §14–§17 ON PURPOSE.** They are stable identifiers into
the three archives; archiving never renumbers, so a §5.2, §11.3 or §17.6 written anywhere still
points at the same words.
🛑 **AND THE RULE THE THREE STUBS EXIST TO ENFORCE: a shipped round's record goes to
`../archive/`, not here.** This file is instruction; those are records. It has now had to be
done three times.
