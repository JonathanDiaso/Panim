...
**Current: `v55`** — `ASSET_V = '55'`, `panim-shell-v55`. The plates are a ribbon. 🗄 The running log of what
...
record: [`../panim-book/handoffs/NEXT.md`](../panim-book/handoffs/NEXT.md) §0.2.
