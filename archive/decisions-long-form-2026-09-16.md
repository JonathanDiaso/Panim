# 🗄 DECISIONS.md, long form, as it stood 2026-09-16 — NOT LIVE

The author found this too hard to read, so `docs/DECISIONS.md` was rewritten in plain English the same day. Every open item was carried over. The measurements and full reasoning behind each suggestion are below, unchanged.
