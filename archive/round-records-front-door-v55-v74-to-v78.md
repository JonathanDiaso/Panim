# 🗄 FRONT DOOR — round records §0–§2 (v55, v74–v78)

**Moved out of `docs/FRONT-DOOR.md` on 2026-09-16, verbatim.** Every one of these shipped.
🛑 **Section numbers are unchanged** — a §0.1, §1.5 or §2.9 written anywhere still means the
words below. **Every ruling in here still stands.**

The two things in here that were still open (§1.5, three checks on a real phone; §2.9, one real
pointer) were carried to `docs/DECISIONS.md`, *Things only your eyes can check*.
